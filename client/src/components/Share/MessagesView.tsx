        ...
        >
          <div className="flex flex-col pb-16 text-sm dark:bg-transparent">
            {(_messagesTree && _messagesTree.length === 0) || _messagesTree === null ? (
              <div className="flex w-full items-center justify-center gap-1 rounded-lg border border-border-light bg-surface-primary/80 p-3 text-sm text-text-secondary backdrop-blur-md">
