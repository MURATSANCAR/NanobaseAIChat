...
function AuthAiVisual() {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="auth-ai-glow absolute inset-[12%] rounded-full bg-sky-400/35 blur-3xl" />
      <div className="auth-ai-glow auth-ai-glow-delay absolute inset-[22%] rounded-full bg-indigo-400/25 blur-2xl" />
      <div className="auth-ai-glow auth-ai-glow-delay-2 absolute inset-[32%] rounded-full bg-cyan-400/20 blur-xl" />
      ...
      >
        ...
        <g className="auth-ai-orbit-slow" style={{ transformOrigin: '100px 100px' }}>
          ...
          <circle cx="100" cy="12" r="4.5" fill="#38bdf8" className="auth-ai-satellite" />
          <circle cx="188" cy="100" r="4" fill="#818cf8" className="auth-ai-satellite auth-ai-satellite-delay-1" />
          <circle cx="100" cy="188" r="3.5" fill="#0ea5e9" className="auth-ai-satellite auth-ai-satellite-delay-2" />
          <circle cx="12" cy="100" r="4" fill="#67e8f9" className="auth-ai-satellite auth-ai-satellite-delay-3" />
        </g>
        ...
        <g className="auth-ai-orbit-reverse" style={{ transformOrigin: '100px 100px' }}>
          ...
          <circle cx="100" cy="32" r="3" fill="#a5b4fc" className="auth-ai-satellite auth-ai-satellite-delay-2" />
          <circle cx="168" cy="100" r="2.5" fill="#38bdf8" className="auth-ai-satellite auth-ai-satellite-delay-4" />
          <circle cx="100" cy="168" r="3" fill="#818cf8" className="auth-ai-satellite auth-ai-satellite-delay-1" />
          <circle cx="32" cy="100" r="2.5" fill="#67e8f9" className="auth-ai-satellite auth-ai-satellite-delay-3" />
        </g>
        ...
        <g className="auth-ai-agents" style={{ transformOrigin: '100px 100px' }}>
          <g className="auth-ai-agent auth-ai-agent-delay-0">
            <circle cx="100" cy="34" r="7" fill="#0c4a6e" stroke="#38bdf8" strokeWidth="1.25" />
            <circle cx="100" cy="34" r="2.5" fill="#67e8f9" className="auth-ai-agent-core" />
          </g>
          <g className="auth-ai-agent auth-ai-agent-delay-1">
            <circle cx="158" cy="130" r="7" fill="#0c4a6e" stroke="#818cf8" strokeWidth="1.25" />
            <circle cx="158" cy="130" r="2.5" fill="#a5b4fc" className="auth-ai-agent-core" />
          </g>
          <g className="auth-ai-agent auth-ai-agent-delay-2">
            <circle cx="42" cy="130" r="7" fill="#0c4a6e" stroke="#0ea5e9" strokeWidth="1.25" />
            <circle cx="42" cy="130" r="2.5" fill="#38bdf8" className="auth-ai-agent-core" />
          </g>
        </g>
        ...
        <g className="auth-ai-core" style={{ transformOrigin: '100px 100px' }}>
          ...
          />
          <line x1="100" y1="48" x2="100" y2="70" stroke="#0ea5e9" strokeWidth="1" className="auth-ai-spoke" />
          <line x1="152" y1="100" x2="130" y2="100" stroke="#6366f1" strokeWidth="1" className="auth-ai-spoke auth-ai-spoke-delay-1" />
          <line x1="100" y1="152" x2="100" y2="130" stroke="#0ea5e9" strokeWidth="1" className="auth-ai-spoke auth-ai-spoke-delay-2" />
          <line x1="48" y1="100" x2="70" y2="100" stroke="#6366f1" strokeWidth="1" className="auth-ai-spoke auth-ai-spoke-delay-3" />
        </g>
      </svg>
      ...
      <div className="auth-ai-status absolute bottom-[6%] flex items-center gap-1.5">
        ...
        <span className="auth-ai-status-dot auth-ai-satellite-delay-1 h-1.5 w-1.5 rounded-full bg-sky-400" />
        <span className="auth-ai-status-dot auth-ai-satellite-delay-2 h-1.5 w-1.5 rounded-full bg-indigo-400" />
      </div>
    </div>
  );
}
