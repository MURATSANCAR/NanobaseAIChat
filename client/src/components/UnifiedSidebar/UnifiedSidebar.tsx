  ...
  if (isSmallScreen) {
    return (
      <>
        <div
          className={cn(
            'nb-colorful-sidebar nb-forge-sidebar fixed left-0 top-0 z-[110] flex h-full backdrop-blur-xl',
        ...
        >
          <SidebarChatProvider>
            <ActivePanelProvider>
              ...
              <nav className="nb-colorful-sidebar nb-forge-sidebar min-h-0 flex-1 overflow-hidden backdrop-blur-xl">
