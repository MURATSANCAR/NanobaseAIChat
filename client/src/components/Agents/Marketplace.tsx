...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`relative flex w-full grow overflow-hidden bg-transparent ${className}`}>
      <SidePanelGroup>
        <main className="flex h-full flex-col overflow-hidden" role="main">
          ...
          >
            ...
            <div className="sticky top-0 z-10 mt-4 bg-[rgba(10,22,40,0.92)] pb-4 backdrop-blur-md md:mt-0">
